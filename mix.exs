defmodule CryptoAlerterElixir.MixProject do
  use Mix.Project
  ...
  def application do
    [
      mod: {CryptoAlerterElixir.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.deploy": [
        "tailwind crypto_alerter_elixir --minify",
        "esbuild crypto_alerter_elixir --minify",
        "phx.digest"
      ],
